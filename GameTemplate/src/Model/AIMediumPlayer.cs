...
/// <summary>
/// The AIMediumPlayer class : is a type of AIPlayer where it will try and destroy a ship if it has found a ship.
/// </summary>
public class AIMediumPlayer : AIPlayer
{
	...
	/// <summary>
    /// GenerateCoordinates: will generate random shooting coordinates
	...
	/// <summary>
    /// TargetCoords : is used when a ship has been hit and it will continue targeting it until it destroys this ship.
	/// </summary>
	...
	/// <summary>
    /// SearchCoords : will randomly generate shots within the grid as long as its not hit the same tile already.
	/// </summary>
	/// <param name="row">the generated row</param>
	/// <param name="column">the generated column</param>
	...
	/// <summary>
    /// ProcessShot :  will be called upon finding a ship.
